...
export function FilterDataClient({avatar, name, address, phone, whatsapp, email, interess}) {
  ...
  <button className="btnAtiveFilter" data-tip data-for='Ver Cliente' onClick={handleFiltro}><IoEyeOutline /></button>
